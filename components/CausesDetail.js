                        ...
                        <div className="blog-content">
                            <div className="blog-item">
                                <div className="blog-img">
                                    <Image width={770} height={453} src="/images/img12.jpg" alt="" />
                                </div>
                                    ...
                                    <div className="inner-causes-img-box row">
                                        <div className="col-lg-6">
                                            <div className="inner-causes-img-item inner-causes-img-item1">
                                                <Image width={370} height={291} src="/images/img13.jpg" alt="" />
                                            </div>
                                        </div>
                                        <div className="col-lg-6">
                                            <div className="inner-causes-img-item inner-causes-img-item2">
                                                <Image width={370} height={291} src="/images/img14.jpg" alt="" />
                                            </div>
                                        </div>
                                    </div>
                                    <p className="causes__text">
                        ...
                        <div className="sidebar-shared">
                            ...
                            <div className="side-widget">
                                ...
                                <div className="author-box recent-donate-item">
                                    <div className="author__avatar">
                                        <Image width={59} height={59} src="/images/author-avatar2.jpg" alt="" />
                                    </div>
                                    <div className="author__detail">
                                ...
                                <div className="author-box recent-donate-item">
                                    <div className="author__avatar">
                                        <Image width={59} height={59} src="/images/author-avatar3.jpg" alt="" />
                                    </div>
                                    <div className="author__detail">
                                ...
                                <div className="author-box recent-donate-item">
                                    <div className="author__avatar">
                                        <Image width={59} height={59} src="/images/author-avatar4.jpg" alt="" />
                                    </div>
                                    <div className="author__detail">
