                ...
                <div className="container">
                            ...
                            <div className="blog-content">
                                <div className="blog-item blog-item1">
                                    ...
                                    <div className="blog-inner-content">
                                        <h3 className="blog__title"><a href="/causes-detail">Provide Medical Help</a>
                                        </h3>
                        ...
                        <div className="col-lg-4">
                            <div className="blog-content">
                                <div className="blog-item blog-item2">
                                    ...
                                    <div className="blog-inner-content">
                                        <h3 className="blog__title"><a href="/causes-detail">Learning / Training Camps</a>
                                        </h3>
                        ...
                        <div className="col-lg-4">
                            <div className="blog-content">
                                <div className="blog-item blog-item3">
                                    ...
                                    <div className="blog-inner-content">
                                        <h3 className="blog__title"><a href="/causes-detail">Sustainable Food Supply</a></h3>
                    ...
                    <div className="col-lg-12">
                        <div className="button-shared">
                            <a href="/causes" className="theme-btn">View more</a>
                        </div>
                    </div>
                </div>
                </div>
