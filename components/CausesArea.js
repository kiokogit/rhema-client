                            ...
                            <div className="blog-content">
                                <div className="blog-item blog-item1">
                                    <div className="blog-img">
                                        <Image width={370} height={317} src="/images/medical poster.jpg" alt="" />
                                    </div>
                        ...
                        <div className="col-lg-4">
                            <div className="blog-content">
                                <div className="blog-item blog-item2">
                                    <div className="blog-img">
                                        <Image width={370} height={317} src="/images/education for all.jpg" alt="" />
                        ...
                        <div className="col-lg-4">
                            <div className="blog-content">
                                <div className="blog-item blog-item3">
                                    <div className="blog-img">
                                        <Image width={370} height={317} src="/images/food serve.jpeg" alt="" />
                                    </div>
